...
Programmable Electrical Rules Checking (ESD clamps, P2P resistance, CD-style path checks) with baseline vs ROI / hierarchical / incremental / parallel engines to study signoff runtime.
